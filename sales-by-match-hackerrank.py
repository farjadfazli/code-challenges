...
def sockMerchant(n, ar):
    # we will loop through the socks and add the number of times a sock is seen to a dictionary i.e. socks[10] = 3. Then we can // 2 to see how many pairs there are
    socks = {}
    for sock in ar:
        socks[sock] = socks.get(sock, 0) + 1
    pairs = [x // 2 for x in list(socks.values())]
    return sum(pairs)
